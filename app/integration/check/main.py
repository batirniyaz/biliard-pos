...
if __name__ == "__main__":
    ...
    order = {
        ...
        "duration": 6,
        "table_income": 6000,
        "products_income": 130000,
        "total": 136000,
        "date": "2024-10-09",
        "status": False,
        "created_at": "2024-10-09T03:26:16.799435Z",
        "updated_at": "2024-10-09T03:54:30.582966Z"
    },
    if prn_txt(order):
        print("Текст успешно отправлен на печать")
    else:
        print("Не удалось отправить текст на печать")
